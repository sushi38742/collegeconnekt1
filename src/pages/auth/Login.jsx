    ...
    <div className="min-h-screen bg-[#f9fafb] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-[24px] font-black tracking-[-0.04em] text-[#1a1a1a]">Welcome back</h1>
          <p className="mt-1.5 text-[13px] text-[#6b6b6b]">Sign in to your account</p>
        </div>
        ...
        <p className="mt-5 text-center text-[12px] text-[#6b6b6b]">
          No account?{' '}
          <Link to="/signup" className="font-semibold text-[#1a1a1a] hover:text-[#2563eb] transition-colors">
            Sign up free
          </Link>
        </p>
      </div>
